...
////
$new_products="";
$sql2 = mysql_query("SELECT * FROM products WHERE category='trousers' ORDER BY date_added DESC");
...
if($count > 0){
   ...
   $new_products = "<p style='color: #C00; font-weight: bold; font-size= 24px;'>No Products In The Store Right Now</p>"; 
