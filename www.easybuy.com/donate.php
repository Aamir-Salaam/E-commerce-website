...
if(isset($_POST['product_name'])){
   ...
   if($_FILES['fileField']['tmp_name'] !=  ""){
      ...
      if($_FILES['fileField']['size'] > $maxfilesize) {
	       ...
	       $newname = ".jpg";
           include_once("scripts/connect.php");
           $sql2 = mysql_query("INSERT INTO products(name,brand,category,sizes,description,price,quantity,date_added,type) VALUES('$product_name','$product_brand','$product_category','$product_sizes','$product_description','$product_price','$product_quantity',now(),'d')");
           $id = mysql_insert_id();
		   $place_file = move_uploaded_file($_FILES['fileField']['tmp_name'],"products/$id".$newname);
		   $msg = "Your item will be reviewed for donation.You will be contacted soon via e-mail for further details.";
         }
     }
	} 
}
...
<body>
	 ...
	 <h2 class="page_title">Donate To Someone:</h2>
	 <br/>
